...
find_player() {
  ...
  local active_player=$(playerctl -l | head -n 1)
...
get_status_and_position() {
  ...
  pos_raw=$(playerctl position 2>/dev/null | cut -d '.' -f1 || echo 0)
